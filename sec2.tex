...
(b) the human representation problem for the blending stage (original vs ours)\\

\includegraphics[ height=2cm, keepaspectratio]{figures/issue/tommaskloss.png} \\
(c) the warped cloth mask color problem and composition mask output (original vs ours) \\
